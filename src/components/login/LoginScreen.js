  ...
  renderLoginContainer = () => {
    ...
    return (
      <View behavior='height'>
        {/** TODO: turn these into modals */
          ['LOGIN', 'BUTTONS'].includes(showingForm) &&
          <LoginForm
            fetching={fetching}
            email={email}
            ...
            onSignupButtonPressed={() => dispatch(LoginActions.showSignupForm())} />
        }
        {
          showingForm === 'SIGNUP' &&
          <SignupForm
            ...
            onCancelButtonPressed={() => dispatch(LoginActions.showButtonsForm())}
            onLoginButtonPressed={() => dispatch(LoginActions.showLoginForm())} />
          }
      </View>
    )
  }
